# Generated by Powerlevel10k configuration wizard on 2023-12-25 at 00:04 MSK.
...
# slanted separators, round heads, round tails, 2 lines, disconnected, no frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='  󰈈 '
